              ...
              "brdBottomPadd-two" id="templateContainer" width="100%">
                <tr>
                  <td class="bodyContent" valign="top" mc:edit="welcomeEdit-02">
                    <h4><strong>Hello {!! $userto->first_name !!} you have a request from {!! $userfrom->first_name !!} {!! $userfrom->first_name !!}</strong><br/>
                    Please approve it from the app by clicking on the chat tab and selecting the requests sub tab
