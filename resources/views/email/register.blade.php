              ...
              "brdBottomPadd-two" id="templateContainer" width="100%">
                <tr>
                  <td class="bodyContent" valign="top" mc:edit="welcomeEdit-02">
                    ...
                    <h1><strong>New user registration<br>
                    via the app!</strong></h1>

                    <h3>a new user has been registerd via the app with the following details</h3>
                  </td>
                </tr>
              </table>
            </td>
                  ...
                  <td align="center" class="bodyContentTicks">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                     ...
                     <tr valign="top">
                      ...
                      <tr valign="top">
                        <td valign="top" mc:edit="welcomeEditTxtFirst" style="width:71%;color:#505050;font-family:Helvetica;font-size:14px;padding-top:0.714em;">
                          <h3><strong>Pharmacy Email</strong></h3>
                          <h4>{!! $user->email !!}</h4>
                        </td>
                        <td valign="top" style="width:5%;">&nbsp;</td>
                      </tr>
                      <tr valign="top">
                        <td valign="top" mc:edit="welcomeEditTxtFirst" style="width:71%;color:#505050;font-family:Helvetica;font-size:14px;padding-top:0.714em;">
                          <h3><strong>Pharmacy Phone</strong></h3>
                    ...
                    <tr valign="top">
                        <td valign="top" mc:edit="welcomeEditTxtFirst" style="width:71%;color:#505050;font-family:Helvetica;font-size:14px;padding-top:0.714em;">
                          <h3><strong>Pharmacy Address</strong></h3>
                      ...
                      <tr valign="top">
                        <td valign="top" mc:edit="welcomeEditTxtFirst" style="width:71%;color:#505050;font-family:Helvetica;font-size:14px;padding-top:0.714em;">
                          <h3><strong>Activation Link for pharmacies with POS system</strong></h3>
                          <h4>{!! $user->link_code !!}</h4>
                          <h3><strong>Activation Link for pharmacies without POS system</strong></h3>
                          <h4>{!! $user->link !!}</h4>
                        </td>
                        <td valign="top" style="width:5%;">&nbsp;</td>
                      </tr>
                      <!--<tr valign="top">
                        <td valign="top" mc:edit="welcomeEditTxtFirst" style="width:71%;color:#505050;font-family:Helvetica;font-size:14px;padding-top:0.714em;">
                          <h3><strong>Photo Of ID</strong></h3>
                                         <p style=
                          "text-align:center;margin:0 0 15px 0;padding:0;">
                          <img height="" src="cid:000001"
                        ...
                        <td valign="top" style="width:5%;">&nbsp;</td>
                                            ...
                                            <tr valign="top">
                        <td valign="top" mc:edit="welcomeEditTxtFirst" style="width:71%;color:#505050;font-family:Helvetica;font-size:14px;padding-top:0.714em;">
                          <h3><strong>Photo Of Signature</strong></h3>
                                         <p style=
                          "text-align:center;margin:0 0 15px 0;padding:0;">
                          <img height="" src="cid:000002"
                          style="display:block;" width="91"></p>
                        </td>
                        <td valign="top" style="width:5%;">&nbsp;</td>
                      </tr>
                      <tr valign="top">
                        <td valign="top" mc:edit="welcomeEditTxtFirst" style="width:71%;color:#505050;font-family:Helvetica;font-size:14px;padding-top:0.714em;">
                          <h3><strong>Photo Of User</strong></h3>
                                         <p style=
                          "text-align:center;margin:0 0 15px 0;padding:0;">
                          <img height="" src="cid:000003"
                          style="display:block;" width="91"></p>
                        </td>
                        <td valign="top" style="width:5%;">&nbsp;</td>
                      </tr>-->
              ...
              "templateContainerFooter" width="100%">
                <tr>
                  <td valign="top" width="100%" mc:edit="welcomeEdit-11">
                    ...
                    <h6 style="text-align:center;margin-top: 9px;">PillFinder</h6>

                    <h6 style="text-align:center;">SHI Group</h6>

                    <h6 style="text-align:center;"> Ntinda, Kampala</h6>
                </tr>
              </table>
            </td>
          </tr>
